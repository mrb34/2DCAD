...
ctx.stroke();
		...
		//	console.log("cox = ",Math.floor(displayTransform.cox),"coy = ",Math.floor(displayTransform.coy));
			//console.log("sclae",displayTransform.scale);
		//	console.log("x = ",displayTransform.x,"y = ",displayTransform.y);
	//		console.log("ox = ",displayTransform.ox,"oy = ",displayTransform.oy);
		//	console.log("dx = ",displayTransform.dy,"dy = ",displayTransform.dy);
			//console.log(" mouse x = ", mouse.rx, "mouse y  = ",mouse.ry);
        }else{
